...
const CONCEPT_ENTRIES: StaticEntrySeed[] = [
  ...
  { id: "concept-ece2035", title: "ECE 2035 at Georgia Tech", description: "StudyRISC-V is designed around the RISC-V and processor concepts used in Georgia Tech ECE 2035.", keywords: ["ece 2035", "ece2035", "georgia tech", "gatech", "processor design", "assembly course"], url: "/docs/#ece-2035", category: "concept", categoryLabel: "Concept", icon: "📚" },
...
const PAGE_ENTRIES: StaticEntrySeed[] = [
  ...
  { id: "page-challenges", title: "Challenges", description: "Short graded programming tasks mapped to the lesson sequence.", keywords: ["challenges", "practice", "graded"], url: "/challenges/", category: "page", categoryLabel: "Page", icon: "🧭" },
