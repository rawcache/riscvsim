...
const DARK_THEME = {
  ...
  rules: [
    ...
    { token: "variable.register", foreground: "4D87F5" },
  ...
  colors: {
    ...
    "editor.lineHighlightBackground": "#2D6BE414",
    "editor.lineHighlightBorder": "#00000000",
    "editorLineNumber.foreground": "#3a3a3a",
    "editorLineNumber.activeForeground": "#4D87F5",
    "editor.selectionBackground": "#2D6BE433",
